...
<div class="modal-body px-5 pb-5">
	<div class="text-center mb-4">
		<h1 class="role-title">Edit Role ({{name}})</h1>
				...
				<table class="table table-flush-spacing">
					<tbody>
						<tr>
							...
							<td>
								<input class="form-control" type="text" name="name" value="{{name}}" placeholder="Роль">
							</td>
						</tr>
						<tr>
							<td class="text-nowrap fw-bolder">
							...
							<td>
								<input class="form-control" type="text" name="role" value="{{role}}" placeholder="ROLE_EXAMPLE_NAME">
							</td>
						</tr>
						<tr>
							<td colspan="2">
