	...
	<td>
		<div class="dropdown">
			...
			<div class="dropdown-menu dropdown-menu-end" style="">
				<a href="{{linkEdit}}" data-nouvu-action="get-modal" class="nouvu-event dropdown-item" data-bs-toggle="modal" data-bs-target="#nouvu-modal">
				...
				<a href="{{linkRemove}}" data-nouvu-action="get-modal" class="nouvu-event dropdown-item" data-bs-toggle="modal" data-bs-target="#nouvu-modal-confirm">
